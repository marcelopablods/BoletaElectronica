...
export class BoletaComponent implements OnInit {
  ...
  ngOnInit( ) {
    ...
    //SE OBTIENE EL 
    this.boletas = this.repService.getData();
    ...
    if(this.rutEmisor == "76803031-6"){
      //this.rutaLogo = "../../../assets/img/Membrete_TurismoJoven.png";
      this.rutaLogo = "assets/img/Membrete_TurismoJoven.png";
    }else{
      this.rutaLogo = "assets/img/pdf.png";
    }
  ...
  /* INICIAMOS LA CONFIGURACION PARA CANVAS */
